...
/// Initializes the ESP32 wifi module's uart port that will be used for future
/// communication
void esp32__init(uart_e esp32_uart_interface);

/// Discards all input from UART until 'timeout_ms' have elapsed without any
/// UART input
 ...
 * If timeout occurs while receiving data, then this function will return with
 * failure (bool = false)
 */
 ...
 * - If expected response is not received, then 'error_message' is printed to
 * standard output
 */
