...
#define xTaskCreateStatic_ExpectAndThrow(pxTaskCode, pcName, ulStackDepth, pvParameters, uxPriority, puxStackBuffer, pxTaskBuffer, cmock_to_throw) xTaskCreateStatic_CMockExpectAndThrow(__LINE__, pxTaskCode, pcName, ulStackDepth, pvParameters, uxPriority, puxStackBuffer, pxTaskBuffer, cmock_to_throw)
