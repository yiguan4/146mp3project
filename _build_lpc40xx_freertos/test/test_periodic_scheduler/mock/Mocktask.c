...
static struct MocktaskInstance
{
  ...
  int xTaskCreateStatic_IgnoreBool;
  TaskHandle_t xTaskCreateStatic_FinalReturn;
  int xTaskCreateStatic_CallbackBool;
...
TaskHandle_t xTaskCreateStatic(TaskFunction_t pxTaskCode, const char* const pcName, const uint32_t ulStackDepth, void* const pvParameters, UBaseType_t uxPriority, StackType_t* const puxStackBuffer, StaticTask_t* const pxTaskBuffer)
{
  ...
  {
    TaskHandle_t ret = Mock.xTaskCreateStatic_CallbackFunctionPointer(pxTaskCode, pcName, ulStackDepth, pvParameters, uxPriority, puxStackBuffer, pxTaskBuffer, Mock.xTaskCreateStatic_CallbackCalls++);
    UNITY_CLR_DETAILS();
    return ret;
  }
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringCalledMore);
  ...
  if (!cmock_call_instance->IgnoreArg_ulStackDepth)
  {
    ...
    if (cmock_call_instance->Expected_ulStackDepth != ulStackDepth) {
  ...
  if (!cmock_call_instance->IgnoreArg_puxStackBuffer)
  {
    ...
    if (cmock_call_instance->Expected_puxStackBuffer != puxStackBuffer) {
  ...
  if (!cmock_call_instance->IgnoreArg_pxTaskBuffer)
  {
    ...
    if (cmock_call_instance->Expected_pxTaskBuffer != pxTaskBuffer) {
...
void xTaskCreateStatic_CMockIgnoreAndReturn(UNITY_LINE_TYPE cmock_line, TaskHandle_t cmock_to_return)
{
  ...
  Mock.xTaskCreateStatic_IgnoreBool = (int)0;
  cmock_call_instance->LineNumber = cmock_line;
  cmock_call_instance->ExceptionToThrow = CEXCEPTION_NONE;
  cmock_call_instance->ExpectAnyArgsBool = (int)0;
  cmock_call_instance->ReturnVal = cmock_to_return;
  Mock.xTaskCreateStatic_IgnoreBool = (int)1;
}
...
{
  Mock.xTaskCreateStatic_IgnoreBool = (int)0;
  Mock.xTaskCreateStatic_CallbackBool = (int)1;
...
{
  Mock.xTaskCreateStatic_IgnoreBool = (int)0;
  Mock.xTaskCreateStatic_CallbackBool = (int)0;
  Mock.xTaskCreateStatic_CallbackFunctionPointer = Callback;
}

void xTaskCreateStatic_CMockExpectAndThrow(UNITY_LINE_TYPE cmock_line, TaskFunction_t pxTaskCode, const char* const pcName, const uint32_t ulStackDepth, void* const pvParameters, UBaseType_t uxPriority, StackType_t* const puxStackBuffer, StaticTask_t* const pxTaskBuffer, CEXCEPTION_T cmock_to_throw)
{
  CMOCK_MEM_INDEX_TYPE cmock_guts_index = CMock_Guts_MemNew(sizeof(CMOCK_xTaskCreateStatic_CALL_INSTANCE));
  CMOCK_xTaskCreateStatic_CALL_INSTANCE* cmock_call_instance = (CMOCK_xTaskCreateStatic_CALL_INSTANCE*)CMock_Guts_GetAddressFor(cmock_guts_index);
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, CMockStringOutOfMemory);
